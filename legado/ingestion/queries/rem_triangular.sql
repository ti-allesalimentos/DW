-- Remessa triangular do Protheus -> raw.rem_triangular
-- Espelho fiel da fFaturamento.xlsx (aba fRemTriangular).
-- ATENÇÃO: no Excel esta query está IDÊNTICA à de rem. industrialização
-- (mesmos CFOPs 5901/5903/6901/6903 e filtros). Mantido igual por fidelidade;
-- revisar com o usuário se a intenção era diferenciá-las.
SELECT
